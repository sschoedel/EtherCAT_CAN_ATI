...
void storeDataFromMaster(AthenaLowLevel* athena)
{
    ...
    if (athena->signalFromMaster == CONTROL_SIGNAL)
    {
        ...
        athena->joint0.direction = MasterToTiva.Byte[DIRECTION0];
        ...
        athena->joint0.dutyCycle = tempConversion.floatData;

        // Set joint 1 direction
        athena->joint1.direction = MasterToTiva.Byte[DIRECTION1];
        ...
        athena->joint1.dutyCycle = tempConversion.floatData;
    }
    ...
    else if (athena->signalFromMaster == MODIFY_FORCES)
    {
        ...
        athena->joint0.forceSensor.offset = tempConversion.floatData;
        ...
        athena->joint0.forceSensor.slope = tempConversion.floatData;
        ...
        athena->joint1.forceSensor.offset = tempConversion.floatData;
        ...
        athena->joint1.forceSensor.slope = tempConversion.floatData;
    }
